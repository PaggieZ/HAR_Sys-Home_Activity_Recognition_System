    ...
    public void run() {
        ...
        while (true) {
            try {
                ...
                byte[] actualData = new byte[numBytes];  // Added this line
                System.arraycopy(mmBuffer, 0, actualData, 0, numBytes); // Added this line
                // Send the obtained bytes to the UI activity.
                Message readMsg = handler.obtainMessage(
                        MESSAGE_READ, numBytes, -1,
                        actualData);  // change mmBuffer to actualData
